...
const buyAirtime = require('./purchaseController').buy('airtime');
...
const retryFailedTransaction = (req, res) => res.status(409).json({
  message: 'Automatic purchase retry is unavailable. Check the original transaction before making a new purchase.'
});
