...
const Security = () => {
  ...
  return (
    <div className="border border-solid border-line rounded-md p-6 w-full">
        ...
        <div className="space-y-8">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="min-h-[44px] text-blue-400 font-semibold hover:text-blue-600"
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-1">
              <span className="text-muted">Transaction Pin</span>
              <span className="text-blue-900">****</span>
            </div>
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-1">
              <span className="text-muted">2FA Settings</span>
      ...
      {changePassword && (
        <div className="fixed top-0 right-0 bottom-0 left-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
          <div className="fixed top-0 right-0 bg-paper rounded-md p-6 w-full max-w-md h-screen w-80">
            <button
              onClick={closeModal}
              className="min-h-[44px] absolute top-2 right-2 text-muted hover:text-gray-700"
