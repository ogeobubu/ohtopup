...
OhTopUp Team`
  ...
  return (
    <div className="min-h-screen ot-admin-soft p-2 md:p-6">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-4 md:mb-8">
          <h1 className="ot-admin-page-title text-xl md:text-4xl font-bold ot-admin-ink mb-2">
            Newsletter Center
          </h1>
          <p className="text-sm md:text-lg ot-admin-muted ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-4 md:mb-8">
          <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs md:text-sm font-medium ot-admin-muted ">Active Subscribers</p>
                <p className="text-lg md:text-3xl font-bold ot-admin-ink ">
          ...
          <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs md:text-sm font-medium ot-admin-muted ">Total Subscribers</p>
                <p className="text-lg md:text-3xl font-bold ot-admin-ink ">
          ...
          <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs md:text-sm font-medium ot-admin-muted ">New This Month</p>
                <p className="text-lg md:text-3xl font-bold ot-admin-ink ">
          ...
          <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs md:text-sm font-medium ot-admin-muted ">Status</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="ot-admin-paper rounded-lg border ot-admin-border ">
              <div className="p-4 md:p-6 border-b ot-admin-border ">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <h2 className="text-lg md:text-xl font-semibold ot-admin-ink ">
                    Compose Newsletter
                  </h2>
                  <div className="flex flex-wrap gap-2">
                    <button
                      onClick={() => insertTemplate('welcome')}
                      className="ot-admin-control px-2 md:px-3 py-1 text-xs md:text-sm bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-md hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                    >
                      Welcome
                    </button>
                    <button
                      onClick={() => insertTemplate('update')}
                      className="ot-admin-control px-2 md:px-3 py-1 text-xs md:text-sm bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded-md hover:bg-green-200 dark:hover:bg-green-800 transition-colors"
                    >
                      Update
                    </button>
                    <button
                      onClick={() => insertTemplate('promotion')}
                      className="ot-admin-control px-2 md:px-3 py-1 text-xs md:text-sm bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-md hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors"
                    >
                      Promotion
                    </button>
                  </div>
              ...
              <form onSubmit={formik.handleSubmit} className="p-4 md:p-6 space-y-4 md:space-y-6">
                <div>
                  <label htmlFor="subject" className="block text-xs md:text-sm font-medium ot-admin-ink mb-2">
                  ...
                  <input
                    ...
                    className={`w-full px-3 md:px-4 py-2 md:py-3 text-sm md:text-base border ot-admin-border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${formik.touched.subject && formik.errors.subject ? 'border-red-500 focus:ring-red-500' : ''}`}
                ...
                <div>
                  <label htmlFor="content" className="block text-xs md:text-sm font-medium ot-admin-ink mb-2">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className={`w-full px-3 md:px-4 py-2 md:py-3 text-sm md:text-base border ot-admin-border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-vertical ${formik.touched.content && formik.errors.content ? 'border-red-500 focus:ring-red-500' : ''}`}
                      placeholder="Write your newsletter content here... Use emojis and formatting to make it engaging!"
                    />
                    <div className="absolute bottom-2 md:bottom-3 right-2 md:right-3 text-xs ot-admin-muted">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mt-2">
                    ...
                    <button
                      ...
                      className="ot-admin-control text-xs md:text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300"
                    >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pt-4 border-t ot-admin-border ">
          ...
          <div className="space-y-4 md:space-y-6">
            {/* Quick Tips */}
            <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
              <h3 className="text-base md:text-lg font-semibold ot-admin-ink mb-3 md:mb-4 flex items-center">
                <FaMagic className="mr-2 text-purple-600 text-sm md:text-base" />
                Newsletter Tips
              </h3>
              <ul className="space-y-2 md:space-y-3 text-xs md:text-sm ot-admin-muted ">
            ...
            {/* Recent Activity */}
            <div className="ot-admin-paper rounded-lg border ot-admin-border p-4 md:p-6">
              <h3 className="text-base md:text-lg font-semibold ot-admin-ink mb-3 md:mb-4">
                Recent Activity
              </h3>
              <div className="space-y-2 md:space-y-3">
                {activityLoading ? (
                  <div className="text-xs md:text-sm ot-admin-muted ">Loading activity...</div>
                  ...
                  activityData.activity.map((item, index) => (
                    <div key={index} className="flex items-center text-xs md:text-sm">
                      ...
                      <span className="ot-admin-muted truncate">
                        New subscriber: {item.email}
                      </span>
                    </div>
                  ))
                ) : (
                  <div className="text-xs md:text-sm ot-admin-muted ">No recent activity</div>
                )}
                {statsData && (
                  <>
                    <div className="flex items-center text-xs md:text-sm">
                      <div className="w-1.5 md:w-2 h-1.5 md:h-2 bg-green-500 rounded-full mr-2 md:mr-3"></div>
                      <span className="ot-admin-muted ">
