        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-green-100 dark:bg-green-900 p-3 rounded-lg">
                <FaPaperPlane className="text-green-600 dark:text-green-400 text-xl" />
              </div>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={formik.handleSubmit} className="p-6 space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-colors ${formik.touched.subject && formik.errors.subject ? 'border-red-500 focus:ring-red-500' : ''}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className={`w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-colors resize-vertical ${formik.touched.content && formik.errors.content ? 'border-red-500 focus:ring-red-500' : ''}`}
