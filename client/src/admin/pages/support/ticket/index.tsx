...
const Ticket = ({ isDarkMode }) => {
  ...
  return (
    <div className="p-4 border border-solid rounded-md border-line w-full">
      ...
      >
        {selectedTicket && (
          <div>
            ...
            <p className="text-ink mb-4">{selectedTicket.description}</p>
                  ...
                  selectedTicket.replies.map((reply) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-ink">{reply.content}</p>
