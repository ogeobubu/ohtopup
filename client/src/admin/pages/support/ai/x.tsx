...
const XPost = () => {
  ...
  return (
    <div className="border border-line rounded-md p-5 w-full max-w-6xl mx-auto bg-paper">
      <h2 className="text-3xl font-bold mb-6 text-ink text-center">
        X API Dashboard
      </h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-5">
        <div className="border border-line rounded-md p-4 bg-bg">
          <h3 className="text-xl font-semibold mb-3 text-ink">X Account Connection</h3>
          <p className="text-sm text-muted mb-4">
            Authorize your X account to enable posting and automatic reposting features.
          </p>
          <button
            onClick={handleInitiateAuth}
            className="min-h-[44px] bg-accent text-white px-6 py-2 rounded-md transition duration-150 ease-in-out flex items-center justify-center gap-2 disabled:opacity-50"
        ...
        <div className="border border-line rounded-md p-4 bg-bg">
          <h3 className="text-xl font-semibold mb-3 text-ink">Repost Telco Posts</h3>
          <p className="text-sm text-muted mb-4">
        ...
        <div className="border border-line rounded-md p-4 bg-bg">
          <h3 className="text-xl font-semibold mb-3 text-ink">Fetch Random Content</h3>
          <button
            type="button"
      ...
      <div className="border border-line rounded-md p-4 bg-bg">
        ...
        <form onSubmit={handlePostSubmit} className="flex flex-col space-y-4">
          <Textarea
            ...
            rows={4}
            className="border border-line rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
          />
          <button
            type="submit"
            className="min-h-[44px] bg-accent text-white px-6 py-2 rounded-md transition duration-150 ease-in-out flex items-center justify-center gap-2 disabled:opacity-50"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex justify-center items-center z-50">
          <div className="relative p-5 border w-full max-w-xl rounded-md bg-paper mx-4">
            <h3 className="text-xl font-semibold mb-4 text-ink">Generated Content</h3>
            <textarea
              readOnly
              value={randomContent}
              className="w-full p-3 border border-line rounded-md mb-4 resize-none focus:outline-none focus:ring-blue-500"
              rows={10}
            ...
            <div className="flex justify-end space-x-3">
              <button
                ...
                className="min-h-[44px] bg-accent text-white px-4 py-2 rounded-md transition duration-150 ease-in-out"
              >
                Copy Content
              </button>
              <button
                onClick={handleCloseModal}
                className="min-h-[44px] bg-gray-300 text-ink px-4 py-2 rounded-md hover:bg-gray-400 transition duration-150 ease-in-out"
              >
                Close
              </button>
            </div>
