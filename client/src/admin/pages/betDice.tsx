          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
           ...
           <div className="bg-paper p-4 md:p-6 rounded-lg border border-line">
             <div className="flex items-center justify-between">
               <div>
                 <p className="text-xs md:text-sm font-medium text-muted">Total Bets</p>
           ...
           <div className="bg-paper p-4 md:p-6 rounded-lg border border-line">
             <div className="flex items-center justify-between">
               <div>
                 <p className="text-xs md:text-sm font-medium text-muted">Avg Bet Size</p>
                 <p className="text-lg md:text-2xl font-bold text-ink">
        ...
        {activeTab === "games" && (
          <div className="bg-paper rounded-lg border border-line overflow-hidden">
            <div className="p-4 md:p-6 border-b border-line">
              <h3 className="text-base md:text-lg font-semibold text-ink">Recent Bet Games</h3>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse bg-paper text-ink text-xs w-full">
                ...
                <tbody className="bg-paper divide-y divide-gray-200 dark:divide-gray-700">
                  {gamesLoading ? (
                    <tr>
                      <td colSpan={5} className="px-3 md:px-6 py-3 md:py-4 text-center text-muted">
                        Loading games...
                      </td>
                    </tr>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-paper p-6 rounded-lg border border-line">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted">Active Bettors</p>
                    <p className="text-2xl font-bold text-ink">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {statsLoading ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted">Most Popular Difficulty</span>
                      <span className="font-semibold text-indigo-600">
                        {betDiceStats?.stats?.mostPopularDifficulty || 'N/A'}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted">Average Odds Taken</span>
              ...
              <div className="bg-paper p-6 rounded-lg border border-line">
                ...
                {statsLoading ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted">Total Bets Placed</span>
                      <span className="font-semibold text-ink">
                        ₦{((betDiceStats?.stats?.totalGames || 0) * (betDiceStats?.stats?.averageBetSize || 0)).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted">Total Payouts</span>
                      <span className="font-semibold text-green-600">
                ...
                {settings.manipulation?.enabled && (
                  <>
                    ...
                    {settings.manipulation?.mode === 'difficulty_based' && (
                      <div className="space-y-4">
                        <h4 className="font-semibold text-ink">Difficulty-Specific Win Probabilities</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {Object.entries(settings.difficultyLevels).map(([key, level]) => (
                            <div key={key} className="p-3 border border-line rounded-lg">
