      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="aboutRight w-full md:w-1/3">
          ...
          <ul className="mt-2 list-none flex flex-col">
            <Link to="/about" className="mb-2 text-white hover:text-gray-300 dark:hover:text-gray-400">About</Link>
            <Link to="/pricing" className="mb-2 text-white hover:text-gray-300 dark:hover:text-gray-400">Data Pricing</Link>
          </ul>
        </div>
      </div>
