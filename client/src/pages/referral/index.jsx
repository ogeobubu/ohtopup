    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div
          ...
          } min-h-[250px] flex flex-col justify-between rounded-lg shadow-md`}
        >
          <div>
          ...
          <div className="mt-4 flex items-center justify-center mx-auto">
            <span
              className={`bg-white border border-solid border-gray-300 py-2 px-4 rounded ${
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <div className="flex flex-col md:flex-row justify-between items-center my-4">
                <h2
                  className={`text-lg sm:text-xl font-bold mr-2 ${
                    isDarkMode ? "text-gray-200" : "text-gray-800"
                  }`}
                >
                  Referrals
              ...
              <div className="overflow-x-auto">
                <div className="md:w-full w-[100px]">
                <table
                  className={`w-full ${
            ...
            <div
              className={`border border-solid rounded-md border-gray-300 p-6 flex flex-col items-center justify-center h-full ${
