...
const Referral = () => {
  ...
  return (
    <>
      <h2 className={`text-xl md:text-2xl font-bold mb-5 ${isDarkMode ? "text-gray-300" : "text-gray-800"}`}>
        Referral
      </h2>
      <div className="flex flex-col md:flex-row gap-4">
        <div className={`flex-1 p-4 ${isDarkMode ? "bg-gray-800" : "bg-gray-100"} min-h-[250px] flex flex-col justify-between rounded-lg shadow-md`}>
          <div>
            ...
            <h2 className={`text-lg md:text-xl font-bold text-center ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
          ...
          <div className="mt-4 flex items-center justify-center mx-auto">
            ...
            <button className="ml-3 bg-blue-500 text-white px-4 py-2 rounded flex items-center" onClick={handleShare}>
        ...
        <div className={`flex-1 md:pl-6 md:pr-6 min-h-[250px] flex flex-col justify-between ${isDarkMode ? "bg-gray-800" : ""}`}>
          {isLoading ? (
            <p className={`${isDarkMode ? "text-gray-300" : "text-gray-800"}`}>Loading referrals...</p>
          ) : isError ? (
            <p className="text-red-500">Error loading referrals: {error.message}</p>
          ) : referrals?.users.length > 0 ? (
            <div className="overflow-x-auto">
              <div className="flex flex-col md:flex-row justify-between items-center my-4">
                <h2 className={`text-lg md:text-xl font-bold mr-2 ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>
                  Referrals
                </h2>
                <div className="flex items-center gap-2">
                  ...
                  />
                  <button className="ml-2 bg-red-500 text-white px-3 py-1 rounded" onClick={handleClearSearch}>
                    Clear
                  </button>
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className={`w-full ${isDarkMode ? "bg-gray-800 text-gray-200" : "bg-white"}`}>
                  <thead className={`${isDarkMode ? "bg-gray-700 text-gray-200" : "bg-gray-100"}`}>
                    <tr>
