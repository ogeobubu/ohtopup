        ...
        <Form className="flex flex-col space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex flex-col">
              <label className="mb-2 block text-ink font-medium">
                Amount (₦)
              </label>
              <Field name="amount">
                {({ field, form }) => (
                  <div className="relative">
                    ...
                    <input
                      ...
                      } text-ink  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                      onChange={(e) => {
                        const value =
          ...
          {/* Transaction Summary */}
          <div className="bg-bg dark:from-gray-700 dark:to-gray-600 rounded-xl p-4">
            <TransactionSummary
